...
import pytz
root=Tk()
root.title("Weater Forecast App")
...
def getWeather():
    try:
        ...
        api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=f934999f2b32d105fbab71b4b441f1ae"
        json_data=requests.get(api).json()
        conditiom=json_data['weather'][0]['main']
        ...
        t.config(text=(temp,"°"))
        c.config(text=(conditiom,"|","FEELS","LIKE",temp,"°"))
        w.config(text=wind)
...
label1=Label(root,text="WIND SPEED",font=("times new roman",15,"bold"),fg="white",bg="#1ab5ef")
label1.place(x=110,y=400)
label2=Label(root,text="HUMIDITY",font=("times new roman",15,"bold"),fg="white",bg="#1ab5ef")
label2.place(x=290,y=400)
label3=Label(root,text="DESCRIPTION",font=("times new roman",15,"bold"),fg="white",bg="#1ab5ef")
label3.place(x=440,y=400)
label4=Label(root,text="PRESSURE",font=("times new roman",15,"bold"),fg="white",bg="#1ab5ef")
